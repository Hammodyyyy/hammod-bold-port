...
export const faqs = [
  { q: "How does pricing work?", a: "Per project, not per screen. Packages are based on how many UI systems your game needs, and implementation in Studio is included in all of them. Complex systems count as 1.5× toward your package. You get a fixed quote up front, so there's no hourly guessing and no surprise add-ons." },
  ...
  { q: "Are your prices fixed?", a: "Package prices are fixed for the scope listed. Complexity is handled by the 1.5× rule on larger systems, so you always know the number before we start." },
